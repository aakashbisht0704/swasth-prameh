...
const heroSlides: HeroSlide[] = [
  {
    id: 'slide-1',
    title: 'Vata',
    subtitle: 'Air and Space',
    description: 'Creative, energetic, quick-thinking. When imbalanced, may experience anxiety, irregular digestion, and variable energy levels.',
    image: '/hero1.jpg',
  ...
  },
  {
    id: 'slide-2',
    title: 'Pitta',
    subtitle: 'Fire and Water',
    description: 'Intelligent, focused, goal-oriented. When imbalanced, may experience inflammation, acidity, and irritability.',
    image: '/hero2.jpg',
  ...
  },
  {
    id: 'slide-3',
    title: 'Kapha',
    subtitle: 'Earth and Water',
    description: 'Stable, calm, nurturing. When imbalanced, may experience weight gain, sluggishness, and congestion.',
    image: '/hero3.jpg',
    ctaText: 'Begin Today',
    ctaLink: '/onboarding',
  },
